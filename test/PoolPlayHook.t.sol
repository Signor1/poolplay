...
contract PoolPlayHookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        // Initialize pool
        localManager.initialize(localKey, TickMath.SQRT_PRICE_1_1, "");
    ...
    function test_lotteryWinnerSelection() public {
        ...
        bytes32 requestId = lotteryPool.epochToRequestID(lastEpoch);
        ...
        (, , uint256 totalFees, , address[] memory participants) = lotteryPool
            .epochs(lastEpoch);
    ...
    function test_placeAndSettleBet() public {
        ...
        // Get the bet ID
        uint256 betId = predictionMarket.bets().length - 1;
        ...
        (, , , bool resolved, bool won) = predictionMarket.bets(betId);
        require(resolved && won, "Bet should be won");
