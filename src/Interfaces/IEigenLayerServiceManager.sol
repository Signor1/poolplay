...
interface IEigenLayerServiceManager {
    ...
    function submitDataValidation(bytes32 operationId, bytes calldata data, uint256 value) external;
    function aggregateValidations(bytes32 operationId) external view returns (bytes memory, bool);
}
